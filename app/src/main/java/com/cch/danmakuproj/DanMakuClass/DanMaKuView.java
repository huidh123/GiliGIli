...
import com.cch.danmakuproj.CustomView.DanMuManager;
...
public class DanMaKuView extends SurfaceView implements SurfaceHolder.Callback, Publisher {
    ...
    private void doDraw(Canvas canvas) {
        ...
        if (canvas != null) {
            ...
            Log.e("danmakuView", "当前绘制弹幕数：" + danMuManager.showingDanmuSpList.size());
            if (isFPSshow) {
                drawFPS(canvas);
                ...
                try {
                    synchronized (surfaceHolder) {
                        ...
                        if (!isPause) {
                            ...
                            long tempTime1 = System.currentTimeMillis() - curTime;
                        ...
                        long tempTime2 = System.currentTimeMillis() - curTime;
                        doDraw(canvas);
                        long deltaTime = System.currentTimeMillis() - curTime;
                        Thread.currentThread().sleep(Math.max(0, (int) (16 - deltaTime)));
                    }
                } catch (InterruptedException e) {
                    e.printStackTrace();
                } finally {
